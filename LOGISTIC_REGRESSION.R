...
# Assuming your test data is stored in 'test_data'
...
# Assuming your test data is stored in 'test_data' with the true labels in 'true_labels' column
...
# Extract the column names of the predictor variables
feature_names <- colnames(training_set)

# Remove the column name of the target variable if it exists
target_variable <- "os.event"  # Replace with the actual name of your target variable
